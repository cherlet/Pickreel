...
private extension ProfileViewController {
    ...
    func setupProfile() {
        ...
        profileView.backgroundColor = ThemeColor.contrast
        profileView.layer.cornerRadius = 16
        profileView.isUserInteractionEnabled = true
        
        profileAvatar.image = UIImage(systemName: "person.circle")
        profileAvatar.tintColor = ThemeColor.white
        
        profileName.text = user.nickname
        profileName.textColor = ThemeColor.white
    ...
    func setupButtons() {
        ...
        settingsButton.tintColor = ThemeColor.background
...
private extension ProfileViewController {
    ...
    func unroll(_ viewController: UIViewController) {
        ...
        settingsButton.tintColor = ThemeColor.general
    }
}

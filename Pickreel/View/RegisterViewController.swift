...
private extension RegisterViewController {
    ...
    func setupTextFields() {
        ...
        nickTextField.textColor = ThemeColor.opp
    ...
    func setupView() {
        formView.backgroundColor = ThemeColor.background
    ...
    func setupButtons() {
        ...
        submitButton.setTitleColor(ThemeColor.background, for: .normal)
        ...
        cancelButton.setTitleColor(ThemeColor.background, for: .normal)
        cancelButton.backgroundColor = ThemeColor.contrast
